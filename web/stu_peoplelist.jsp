        ...
        <nav class="navbar p-0 fixed-top d-flex flex-row">
          ...
          <div class="navbar-menu-wrapper flex-grow d-flex align-items-stretch">
            ...
            <li class="nav-item dropdown border-left">
                <a class="nav-link btn  btn-inverse-secondary create-new-button"  href="edit_student_acc.jsp?email=${email}&name=${sname}&filename=${sfilename}&code=${code}" >
                <i class="mdi mdi-lead-pencil"></i> Edit Profile
                  
                </a>
              </li>
              <li class="nav-item dropdown border-left">
                <a class="nav-link btn  btn-inverse-secondary create-new-button"  href="student_list.jsp" >
