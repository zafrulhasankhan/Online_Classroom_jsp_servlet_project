<%-- 
    Document   : attendance_sheet1
    Created on : Jul 17, 2020, 11:03:08 AM
...
<html lang="en">
  ...
  <body>
    <%
            String tecemail = session.getAttribute("tecemail2").toString();
            String tecname = session.getAttribute("tecname2").toString();
          ...
          <li class="nav-item menu-items">
            ...
            <div class="collapse" id="auth">
              <ul class="nav flex-column sub-menu">
                  ...
                  %>
                   <li class="nav-item"> <a class="nav-link" href="delete_course_cotroller?code=<%=code%>&email=<%=tecemail%>&name=<%=tecname%>&filename=${filename}"> <%=code%> -- <%=course_name%> </a></li>
                <%}%>
              </ul>
            </div>
          </li>
      ...
      <div class="container-fluid page-body-wrapper">
        ...
        <div class="main-panel">
          <div class="content-wrapper">
              <h4 style=" text-align: center"><u>Attendance Sheet</u></h4><br>
              <form action="attendance_insert_controller" method="post">
                  <input type="text"  hidden=""   value="<%= tecemail%>" name="adtecemail"/>
            <input type="text" hidden=""    value="<%= tecname%>" name="adtecname"/>
              <input type="text" hidden=""   value="${filename}" name="adfilename"/>
            ...
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item"><h5>Date:<input type="date"  name="date" class="form-control form-control-sm" style="width: 180px; float:right; color:white" placeholder="Enter Class No" aria-label="Username" required=""></h5></li>
              ...
              <div class="col-lg-12 grid-margin stretch-card">
                ...
                <div class="card">
                    ...
                    <div class="form-group" style=" text-align:center;">
                        <label>
                            <input type="text" class="form-control form-control-sm" placeholder="Enter Class No"   name="classno" style="width: 127px; color:white; background:black;border:2px white solid; text-align:center;"  aria-label="Username" required="">
                            <br><h7 style="color:white;"> Last Class No. : ${class_no} </h7>
                      </label>
                    </div>
                ...
                for(people po : attendlist){
                    i++;
                          ...
                          <tr>
                            <td class="py-1">
                              <img src="getimage_student.jsp?filename=<%=po.getPhoto()%>" alt="image" style=" width:50px; height:50px;" />
                            </td>
                            <td> 
                                <%= po.getClass_id()%> 
                            <input type="text" hidden=""   value="<%= po.getClass_id()%>" name="id"/>
                            </td>
                            <td>
                              <%= po.getStudentlist()%>
                              <input type="text" hidden="" value="<%= po.getStudentlist()%>" name="name"/>
                            </td>
                            <td>
                                
                            <div class="form-check form-check-success">
                              <label class="form-check-label">
                                  <input type="radio" class="form-check-input" name="<%=i%>" value="present" ></label>
                            </div>
                            ...
                            <td>
                                ...
                                <div class="form-check form-check-danger" style=" margin: 0 auto;">
                                    <label class="form-check-label"> 
                                        
                                        <input type="radio" class="form-check-input" name="<%=i%>" value="absent" ></label>
       ...
       <input type="text" name="te" value="<%=i%>" hidden="" >              
