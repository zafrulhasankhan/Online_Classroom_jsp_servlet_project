<%-- 
    Document   : individual_report_result1
    Created on : Jul 25, 2020, 2:41:43 PM
      ...
      <div class="container-fluid page-body-wrapper">
        ...
        <div class="main-panel">
          <div class="content-wrapper">
              <h4 style=" text-align: center"><u>Individual - Attendance - Report</u></h4><br>
                    ...
                    <div class="table-responsive">
                      <table class="table table-striped">
                        ...
                        <tbody>
                          ...
                          <tr>
                            <td class="py-1">
                                <img src="getimage_student.jsp?filename=${sfilename}" alt="image" style=" width:65px; height:65px;">
                            </td>
                            <td> 
                                <%= classid%> 
