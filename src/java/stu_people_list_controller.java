 ...
 */
@WebServlet(urlPatterns = {"/stu_people_list_controller"})
public class stu_people_list_controller extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        //String code="ict-3109";
         String h_email = request.getParameter("email");
          ...
          String htecname = request.getParameter("tecname");
            ...
            ResultSet rs=ps1.executeQuery();
             while(rs.next()){
               ...
               po.setPhoto(rs.getString("filename"));
                ...
                request.setAttribute("email", h_email);
                request.setAttribute("sname", sname);
                request.setAttribute("tecname", htecname);
             ...
             if(rs1.next()){
               ...
               String tecname = rs1.getString("teacher_name");
                ...
                session.setAttribute("cname", course_name);
             ...
             request.getRequestDispatcher("stu_peoplelist.jsp").forward(request,response);
             }
                else{
