  ...
  <body>
    ...
    <div class="container-scroller">
      ...
      <div class="container-fluid page-body-wrapper">
        ...
        <div class="main-panel">
          <div class="content-wrapper">
              <h4 style=" text-align: center"><u>Student - Classwork - Marks</u></h4><br>
            ...
            <input type="text" name="tecfile" value="${filename}"  hidden="" placeholder="out of 10">
            <input type="text" name="tecname" value="<%=tecname%>"  hidden="" placeholder="out of 10">
            <div class="page-header">
                
                <h3 class="page-title"> Classwork no. : ${cwno} </h3>
        ...
        %>
                          <tr>
                            <td class="py-1">
                              <img src="getimage_student.jsp?filename=<%=u.getFilephoto()%>" alt="image" style=" width:50px; height:50px;" />
                            </td>
                            <td> 
                               <%= u.getStudent_id()%>
                            <input type="text" hidden=""   value="<%= u.getStudent_id()%>" name="stuid"/>
                            </td>
                            <td> 
                               <%= u.getStudent_name()%>
                            <input type="text" hidden=""   value="<%= u.getStudent_name()%>" name="stuname"/>
                            </td>
                            <td>
                              <%= u.getStudent_email()%>
                              <input type="text" hidden="" value="<%= u.getStudent_email()%>" name="stuemail"/>
                            </td>
                            <td>
                              <%= u.getMark()%>
                              <input type="text" hidden="" value="<%= u.getMark()%>" name="stumark"/>
                            </td>
      ...
      <h3 style="text-align:center">
            <button type="submit" class="btn btn-success btn-fw">Marks Sent to Gmail</button>
      </h3>
              </form>
