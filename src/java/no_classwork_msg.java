 ...
 */
@WebServlet(urlPatterns = {"/no_classwork_msg"})
public class no_classwork_msg extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
      ...
      HttpSession session = request.getSession();
        ...
        System.out.println(code+semail+"ujfhuh");
     try {
